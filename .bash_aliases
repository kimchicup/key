...
alias pm.start='echo \“Wait for 30s .….\” && sudo systemctl start beacon && sleep 10s && sudo systemctl start validator && sleep 10s && sudo systemctl start mevboost && sleep 10s && echo \“Done.\"'
alias pm.stop='echo \”Wait for 15s …..\” && sudo systemctl stop mevboost && sleep 5s && sudo systemctl stop validator && sleep 5s && sudo systemctl stop beacon && echo \”Done.\"'
